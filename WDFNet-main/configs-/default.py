...
_C.MODEL = CN()
_C.MODEL.NAME = 'wdfnet_small'
_C.MODEL.PRETRAINED = 'pretrained_models/imagenet/WDFNet_S_ImageNet.pth.tar'
_C.MODEL.ALIGN_CORNERS = True
_C.MODEL.NUM_OUTPUTS = 2
_C.MODEL.ROIAE_WO_GEOMETRY = False
_C.MODEL.ROIAE_WO_STATISTICS = False
_C.MODEL.ROIAE_WO_EDGE = False
_C.MODEL.WFD_WO_WAVELET = False
_C.MODEL.ROIAE_USE_16 = True
_C.MODEL.ROIAE_USE_32 = True
_C.MODEL.WFD_USE_8 = True
_C.MODEL.WFD_USE_16 = True
_C.MODEL.WFD_USE_32 = True
...
_C.LOSS.GATE_WEIGHTS = 1.0
_C.LOSS.WAVE_WEIGHTS = 0.4
